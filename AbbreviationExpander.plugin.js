...
module.exports = (_ => {
    ...
    return !window.BDFDB_Global || (!window.BDFDB_Global.loaded && !window.BDFDB_Global.started) ? class {
        ...
        const abbreviations = {
            ...
            'ftw': 'for the win',
            'fubar': 'fxxxxx up beyond all recognition',
            'fuq/fuqn': 'fxxx/fxxxing',
            ...
            'lmfao': 'laughing my fxxxing axx off',
            'lmk': 'let me know',
            'lol': 'laugh out loud',
            ...
            'smh': 'shaking my head',
            'snafu': 'situation normal, all fxxxxx up',
            'stfu': 'shut the fxxx up',
            'sus': 'suspicious',
